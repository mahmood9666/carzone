  ...
  <div class="banner header-text">
    <div class="banner-item-03">
      <div class="text-content">
        <h4>مهمتنا إزالة عناء البحث</h4>
        <h2>نتمنى أن تجد طلبك</h2>
      </div>
    </div>
  </div>
  <!-- Banner Ends Here -->
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="section-heading">
            ...
            <a href="cars.php" class="col-12">عرض المزيد<i class="fa fa-angle-right"></i></a>
          </div>
        </div>
        ...
        <?php
            ...
            $repage=6;
            $numrows=$database->prepare("SELECT * FROM cars");
            $numrows->execute();
            ...
            $result=$database->prepare("SELECT * FROM cars ORDER BY 'id_car' DESC LIMIT " .$repage. " OFFSET " . ($page-1) * $repage);
            $result->execute();
            ...
            for($c=1;$c<=$total;++$c)
            {
              ...
              ?>
                <li class="page-item disabled" style="display:inline;">
                 <a class="page-link" href="cars.php?page=<?php echo $c ?>"><?php echo $c ?></a>
                </li>
              <?php
              }
              else
              {
                ...
                <li class="page-item" style="display:inline; ">
                 <a style="color:#f33f3f;"  class="page-link" href="cars.php?page=<?php echo $c ?>"><?php echo $c ?></a>
                </li>
               <?php
              }
            }
