          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown active">
              ...
              <div class="dropdown-menu ">
                <a class="dropdown-item active" href="new_car.php">سيارات جديدة</a>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="section-heading">
            <h2 style="text-align:right;">أخر منشورات السيارات الجديدة</h2>
          </div>
        </div>
        <?php
         
         $repage=6;
         $numrows=$database->prepare("SELECT * FROM cars WHERE car_state='جديدة'");
         $numrows->execute();
         ...
         $result=$database->prepare("SELECT * FROM cars WHERE car_state='جديدة'  ORDER BY 'id_car' DESC LIMIT " .$repage. " OFFSET " . ($page-1) * $repage);
         $result->execute();
         ...
         for($c=1;$c<=$total;++$c)
         {
           ...
           ?>
             <li class="page-item disabled" style="display:inline;">
              <a class="page-link" href="new_car.php?page=<?php echo $c ?>"><?php echo $c ?></a>
             </li>
           <?php
           }
           else
           {
             ...
             <li class="page-item" style="display:inline; ">
              <a style="color:#f33f3f;"  class="page-link" href="new_car.php?page=<?php echo $c ?>"><?php echo $c ?></a>
             </li>
            <?php
           }
         }
